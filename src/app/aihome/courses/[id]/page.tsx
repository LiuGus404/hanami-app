            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 flex-shrink-0 ml-4">
                {orgRoute && (
                  <button
                    onClick={() => router.push(orgRoute)}
                    className="px-3 py-1.5 text-xs rounded-lg border border-[#EADBC8] text-[#4B4036] bg-white hover:bg-[#FFF9F2] transition whitespace-nowrap"
                  >
                    查看機構
                  </button>
                )}
                {(org?.contact_phone || orgSettings?.contactPhone) && (() => {
                  ...
                  return (
                    <a
                      ...
                      className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-[#FFD59A] to-[#EBC9A4] text-[#4B4036] rounded-lg text-xs font-medium shadow-sm hover:shadow transition-all duration-200 border border-[#EAC29D] hover:from-[#EBC9A4] hover:to-[#FFD59A] whitespace-nowrap"
                    >
