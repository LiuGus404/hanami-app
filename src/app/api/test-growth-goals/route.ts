...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      ...
      testGoalData,
      fieldCheck: {
        hasProgressMax: insertData.hasOwnProperty('progress_max'),
        hasRequiredAbilities: insertData.hasOwnProperty('required_abilities'),
        hasRelatedActivities: insertData.hasOwnProperty('related_activities'),
        hasProgressContents: insertData.hasOwnProperty('progress_contents'),
        hasIsCompleted: insertData.hasOwnProperty('is_completed'),
