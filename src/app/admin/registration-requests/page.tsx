...
export default function RegistrationRequestsPage() {
  ...
  useEffect(() => {
    ...
    console.log('Registration Requests Page - User Session:', userSession);
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-3xl font-bold text-[#2B3A3B]">註冊申請管理</h1>
            </div>
          </div>
          <p className="text-[#555] mt-2">審核和管理用戶註冊申請</p>
        </div>
