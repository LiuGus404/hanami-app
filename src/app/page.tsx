        ...
        <div className="flex-1 p-4">
          ...
          <div className="mb-8">
            ...
            <nav className="space-y-2">
              <Link href="/dashboard" className="flex items-center space-x-3 p-3 rounded-lg hover:bg-[#FFF9F2] transition-colors group">
              ...
              <Link href="/tools" className="flex items-center space-x-3 p-3 rounded-lg hover:bg-[#FFF9F2] transition-colors group">
                <div className="w-6 h-6 text-[#4B4036] group-hover:text-[#FFD59A] transition-colors">
                  <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link href="/settings" className="flex items-center space-x-3 p-3 rounded-lg hover:bg-[#FFF9F2] transition-colors group">
                <div className="w-6 h-6 text-[#4B4036] group-hover:text-[#FFD59A] transition-colors">
                  <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="bg-white border-b border-[#EADBC8] px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-3">
            ...
            <span className="text-lg font-bold text-[#4B4036]">Hanami</span>
          </div>
          ...
          <input
            ...
            <div className="bg-white border border-[#EADBC8] rounded-2xl p-6 shadow-sm mb-8">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-[#4B4036] mb-1">Unlock all features</h3>
                  <p className="text-[#4B4036]/70">and benefits</p>
                </div>
