...
export default function TaskDashboard({ userPhone, onTaskEdit, onTaskCreate, taskFilter, userSession, personalTasks }: TaskDashboardProps) {
  ...
  useEffect(() => {
    fetchTasks();
    fetchStats();
  }, [userPhone, statusFilter, priorityFilter, categoryFilter, sortBy, sortOrder]);
