...
interface DebugCameraTestProps {
...
export default function DebugCameraTest({ 
  onScanSuccess, 
  onScanError, 
  onClose, 
  isActive 
}: DebugCameraTestProps) {
          ...
          try {
            ...
            setTimeout(async () => {
              try {
                ...
                addDebugInfo(`延遲播放也失敗: ${delayedError}`);
                setError('無法播放相機畫面');
              }
            }, 1000);
          }
    ...
    <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl p-6 max-w-lg w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-[#4B4036]">掃描 QR 碼 (調試版)</h3>
          <button
            onClick={handleClose}
